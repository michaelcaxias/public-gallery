...
export default function Form() {
  ...
  const handleFormSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const api = process.env.VITE_SERVER || 'http://0.0.0.0:3001/images';
  ...
  return (
    <div className="flex h-screen bg-gray-200 items-center justify-center">
      <form
        ...
        className="grid bg-white rounded-lg py-5 shadow-xl w-11/12 md:w-9/12 lg:w-1/2 border-purple-700"
      >
